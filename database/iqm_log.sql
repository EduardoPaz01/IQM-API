...
CREATE TABLE `log` (
  ...
  `aswer-selection` varchar(45) DEFAULT NULL,
  `date` date NOT NULL,
  `idquestion` int NOT NULL,
  PRIMARY KEY (`idlog`),
  UNIQUE KEY `idlog_UNIQUE` (`idlog`),
  KEY `fk_log_question1_idx` (`idquestion`),
  CONSTRAINT `fk_log_question1` FOREIGN KEY (`idquestion`) REFERENCES `question` (`idquestion`)
